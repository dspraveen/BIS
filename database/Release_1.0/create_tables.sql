...
CREATE TABLE Stock (
  ...
  FOREIGN KEY(Item_Code) REFERENCES Item(Item_Code) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE ST_Details (
  ...
  FOREIGN KEY(Item_Code) REFERENCES Item(Item_Code) ON DELETE NO ACTION ON UPDATE NO ACTION,
  FOREIGN KEY(Transaction_ID) REFERENCES Sales_Transaction(Transaction_ID) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE PT_Details (
  ...
  FOREIGN KEY(Transaction_ID) REFERENCES Procurement_Transaction(Transaction_ID) ON DELETE NO ACTION ON UPDATE NO ACTION,
  FOREIGN KEY(Item_Code) REFERENCES Item(Item_Code) ON DELETE NO ACTION ON UPDATE NO ACTION
);
